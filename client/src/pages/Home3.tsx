            ...
            {[
              ...
              <Card
                ...
                style={[0, 1, 2, 3, 4, 5].includes(idx) ? {
                  backgroundImage: `linear-gradient(rgba(255,255,255,0.70), rgba(255,255,255,0.70)), url(${idx === 0 ? '/git-integration.png' : idx === 1 ? '/logo-kotlin.svg' : idx === 2 ? '/tiny-logo-arcmutate.svg' : idx === 3 ? '/tiny-logo-arcmutate.svg' : idx === 4 ? '/operators.png' : '/maven-logo.svg'})`,
